...
const SearchBar = () => {
    ...
    return (
        <div className='flex gap-1 items-center'>
            <input type="text" value={searchText} onChange={(e)=>dispatch(setSearchText(e.target.value))} placeholder='Search' className='border outline-none w-full  rounded-lg p-2' />
